...
match3_info = extract_match_info(html3)
    ...
    st.markdown(f"**Tournament:** {match1_info['tournament']}")
    st.markdown(f"**Time:** {match1_info['time']}")
    st.markdown(f"**Home Player:** {match1_info['home_player']['name']} ({match1_info['home_player']['country']}) [{match1_info['home_player']['seed']}]")
    st.markdown(f"**Away Player:** {match1_info['away_player']['name']} ({match1_info['away_player']['country']}) [{match1_info['away_player']['seed']}]")

    st.markdown("---")
    st.subheader("Upcoming Match 2")
    st.markdown(f"**Tournament:** {match2_info['tournament']}")
    st.markdown(f"**Time:** {match2_info['time']}")
    st.markdown(f"**Home Player:** {match2_info['home_player']['name']} ({match2_info['home_player']['country']}) [{match2_info['home_player']['seed']}]")
    st.markdown(f"**Away Player:** {match2_info['away_player']['name']} ({match2_info['away_player']['country']}) [{match2_info['away_player']['seed']}]")

    st.markdown("---")
    st.subheader("Upcoming Match 3")
    st.markdown(f"**Tournament:** {match3_info['tournament']}")
    st.markdown(f"**Time:** {match3_info['time']}")
    st.markdown(f"**Home Player:** {match3_info['home_player']['name']} ({match3_info['home_player']['country']}) [{match3_info['home_player']['seed']}]")
    st.markdown(f"**Away Player:** {match3_info['away_player']['name']} ({match3_info['away_player']['country']}) [{match3_info['away_player']['seed']}]")
